  ...
  return (
    <div className="min-h-screen bg-background text-on-background p-4 md:p-8 pt-[104px]">
      ...
      <div className="max-w-5xl mx-auto flex flex-col gap-8">
        ...
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center bg-surface-container rounded-xl border border-outline-variant p-8 shadow-lg">
          <div className="flex flex-col gap-1">
            ...
            <div className="flex items-center gap-4 mt-3">
              ...
              <span className="font-data-mono text-sm text-on-surface-variant flex items-center gap-1">
        ...
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 flex flex-col gap-6 shadow-md">
          <div className="flex justify-between items-center">
            <h3 className="font-heading-table text-on-surface-variant uppercase tracking-[0.15em] flex items-center gap-3 text-sm">
              <span className="material-symbols-outlined text-primary">leaderboard</span>
              Price Action & Technical Layers
            </h3>
            <div className="flex gap-4 font-data-mono text-[11px] text-on-surface-variant">
              <span className="flex items-center gap-2"><div className="w-3 h-0.5 bg-[#06b6d4]"></div> EMA 20</span>
              <span className="flex items-center gap-2"><div className="w-3 h-0.5 bg-[#a855f7]"></div> EMA 50</span>
              <span className="flex items-center gap-2"><div className="w-3 h-3 bg-orange-400/20 border border-orange-400/40 rounded-sm"></div> BB Bands</span>
            </div>
          </div>

          <div className="w-full h-[500px] bg-[#020817] rounded-xl border border-outline-variant/30 relative overflow-hidden flex items-center justify-center">
            <CandlestickChart
              ohlcv={ohlcv}
              ema20={ema20}
              ema50={ema50}
        ...
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 shadow-md">
          <h3 className="text-xs font-bold text-on-surface-variant uppercase tracking-[0.2em] mb-6 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="flex flex-col gap-1 p-5 bg-background/40 rounded-xl border border-outline-variant/50">
                <span className="text-[10px] text-on-surface-variant font-bold uppercase tracking-wider">{item.label}</span>
                <span className="font-data-mono text-2xl font-bold text-on-surface">{item.value}</span>
                <span className={`text-[10px] font-bold ${item.color}`}>{item.meta}</span>
              </div>
            ))}
          </div>
        </section>
        ...
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 flex flex-col gap-6 shadow-md">
          <div className="flex justify-between items-center border-b border-outline-variant pb-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-2xl font-bold text-on-surface uppercase tracking-tight">Analyst Desk Briefing</h2>
                <span className="text-xs text-on-surface-variant font-data-mono">AI-Generated Strategy Reasoning</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-3">
              <h4 className="text-xs uppercase font-bold text-on-surface-variant mb-4 tracking-widest">Rationale & Analysis</h4>
              <div className="text-on-surface text-lg leading-relaxed bg-background p-8 rounded-2xl border border-outline-variant/40 shadow-inner italic">
                "{stock.reasoning}"
              </div>
            </div>
            <div className="flex flex-col gap-6">
              <div className="p-5 bg-background/50 rounded-xl border border-outline-variant/30">
                <h4 className="text-[10px] uppercase font-bold text-on-surface-variant mb-3 tracking-widest">Trading Style</h4>
                <div className="flex items-center gap-3 text-lg text-on-surface font-semibold">
                  <span className="material-symbols-outlined text-primary">timer</span>
                  {stock.trading_style}
                </div>
              </div>
              <div className="p-5 bg-background/50 rounded-xl border border-outline-variant/30">
                <h4 className="text-[10px] uppercase font-bold text-on-surface-variant mb-3 tracking-widest">Data Horizon</h4>
                <div className="flex items-center gap-3 text-lg text-on-surface font-semibold">
        ...
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 flex flex-col gap-6 shadow-md">
           <h3 className="text-sm font-bold text-on-surface-variant uppercase tracking-[0.2em] flex items-center gap-3">
        ...
        <section className="bg-surface-container rounded-xl border border-outline-variant p-8 shadow-md">
          <h3 className="text-sm font-bold text-on-surface-variant uppercase tracking-[0.2em] mb-6 flex items-center gap-3">
        ...
        {/* Footer Disclaimer */}
        <footer className="text-center py-8 text-[11px] text-on-surface-variant uppercase tracking-[0.2em] opacity-60">
